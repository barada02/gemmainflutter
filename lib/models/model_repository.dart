...
class ModelRepository {
  static const Map<String, AIModel> availableModels = {
    'gemma-3n-E2B-it-UD-IQ2_XXS': AIModel(
      ...
      name: 'Gemma 3N E2B IT (Ultra Quantized)',
      url: 'https://huggingface.co/unsloth/gemma-3n-E2B-it-UD-IQ2_XXS/resolve/main/gemma-3n-E2B-it-UD-IQ2_XXS.gguf?download=true',
